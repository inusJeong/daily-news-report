...
- **30일 과정 × 하루 15단어 = 450단어** (`data/toeic_words.json`). 날마다 주제가 있고(계약·법무 → 인사·채용 → … → Part 5 고난도 부사), 토익 Part 5·6에 그대로 나오는 **짝꿍 표현(연어)** 과 함께 외웁니다.
- **간격 반복 복습**: 오늘 새 단어 + 1·3·7·14·28 학습일 전 단어를 다시 보여줍니다. 복습 단어는 뜻이 가려져 있고, 떠올린 뒤 눌러서 확인합니다.
- 🔊를 누르면 원어민 발음(휴대폰 음성)을 들을 수 있습니다. 새 단어도 "뜻 가리고 테스트"로 셀프 테스트할 수 있습니다.
...
data/toeic_words.json  토익 단어 450개 (30일 × 15단어, 주제별)
